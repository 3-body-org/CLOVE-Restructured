// Theme-specific content configurations
    ...
    cards: [
      {
        ...
        description:
          "Declare your magical intentions with precise incantations.",
...
// Card content that can be used across themes
