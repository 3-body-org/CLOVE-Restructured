...
def upgrade() -> None:
    ...
    sa.Column('snippet_choices', sa.JSON(), nullable=False),
    sa.Column('difficulty', sa.Enum('easy', 'medium', 'hard', name='difficulty_enum'), nullable=False),
    sa.Column('hints', sa.JSON(), nullable=True),
    sa.Column('timer', sa.Integer(), nullable=True, comment='Time limit in seconds'),
    ...
    sa.Column('matching_game', sa.String(), nullable=True),
